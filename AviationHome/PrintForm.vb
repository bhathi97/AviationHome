...
Public Class PrintForm
    ...
    Public Sub CreatePDFDOcument()
        ...
        For pc As Integer = 1 To pageCount
            ...
            Dim numDataRows As Integer = Math.Min(dgPrint.Rows.Count, 19) ' number of rows with data
            ...
            For i As Integer = startIndex To stopIndex + 1 ' loop through rows 
                If i <= numDataRows - 1 Then

                    For j As Integer = 1 To 2
                        Dim cellRect1 As New XRect(tableLeft, 110 + (i - startIndex + 1) * rowHeight, 50, rowHeight)
                        ...
                        Dim cellRect2 As New XRect(tableLeft + 50, 110 + (i - startIndex + 1) * rowHeight, 20, rowHeight)
                        ...
                        Dim cellRect3 As New XRect(tableLeft + 70, 110 + (i - startIndex + 1) * rowHeight, 60, rowHeight)
                        ...
                        Dim cellRect4 As New XRect(tableLeft + 130, 110 + (i - startIndex + 1) * rowHeight, 50, rowHeight)
                        ...
                        Dim cellRect5 As New XRect(tableLeft + 180, 110 + (i - startIndex + 1) * rowHeight, 55, rowHeight)
                        ...
                        Dim cellRect6 As New XRect(tableLeft + 235, 110 + (i - startIndex + 1) * rowHeight, 80, rowHeight)
                        ...
                        Dim cellRect7 As New XRect(tableLeft + 315, 110 + (i - startIndex + 1) * rowHeight, 65, rowHeight)
                        ...
                        Dim cellRect8 As New XRect(tableLeft + 380, 110 + (i - startIndex + 1) * rowHeight, 65, rowHeight)
                        ...
                        Dim cellRect9 As New XRect(tableLeft + 445, 110 + (i - startIndex + 1) * rowHeight, 65, rowHeight)
                        ...
                        Dim cellRect10 As New XRect(tableLeft + 510, 110 + (i - startIndex + 1) * rowHeight, 60, rowHeight)
                ...
                Else
                    ' loop through remaining cells and fill in empty strings
                    For j As Integer = 1 To 2 ' loop through columns

                        Dim cellRect1 As New XRect(tableLeft, 110 + (i - startIndex + 1) * rowHeight, 50, rowHeight)
                        gfx.DrawRectangle(rowPen, cellRect1)
                        gfx.DrawString("", tableFont, XBrushes.Black, cellRect1, XStringFormats.Center)
                        j += 1
    ...
    Public Sub CreatePDFDOcument1()
        ...
        For pc As Integer = 1 To pageCount
            ...
            Dim startIndex As Integer = pc * 20 - 20
            Dim stopIndex As Integer = pc * 20 - 1
            ' MsgBox("start - " & startIndex & "    stop - " & stopIndex)
